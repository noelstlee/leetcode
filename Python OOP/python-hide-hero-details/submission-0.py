class SuperHero:
    def __init__(self, name: str, health: int, power_level: int):
        """ initialize the superhero object. """
        self.name = name
    ...
    def get_health(self) -> int:
        """ Return the health of the superhero object. """ 
        return self.__health
    
    def get_power_level(self) -> int:
        """ Return the power level of the superhero object. """
        return self.__power_level
    
    def set_health(self, new_health: int) -> None:
        """ Validate health of the super hero object and if condition meets, set the new health. """
        if new_health > 100:
    ...
    def set_power_level(self, new_power_level: int) -> None:
        """ Validate the power level of the passed in new power level of the super hero object and if condition meets set new power level"""
